"""
Django settings for dev_defna_org project.
...
SECRET_KEY = env.str(
    "SECRET_KEY",
    default="django-insecure-d*mczd919i*5io)s9g#ny7!dhgqy_x%a=bq170#n_=zq9lws!h",
)
...
DATABASES = {
    "default": env.dj_db_url("DATABASE_URL", default="postgres:///dev_defna_org"),
}
